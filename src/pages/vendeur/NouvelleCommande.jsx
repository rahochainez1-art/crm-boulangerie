            ...
            {(() => {
              ...
              return (
                <div
                  ...
                  style={{ backgroundColor: bg, border: '1px solid rgba(67,47,46,0.06)' }}
                >
                  <div
                    className="flex items-center justify-center flex-shrink-0"
                    style={{ width: 32, height: 32, borderRadius: 9999, backgroundColor: iconBg }}
                  >
